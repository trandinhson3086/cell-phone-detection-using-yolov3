...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='data/cell_phone.data', help='*.data path')
    ...
    parser.add_argument('--name', default='200227', help='renames results.txt to results_name.txt if supplied')
